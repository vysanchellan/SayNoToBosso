          ...
          {sent ? (
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full rounded-xl border border-muted-foreground/20 bg-white px-4 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
              <Button
