  ...
  return (
    <div id="main-content" className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl border bg-amber-50 border-amber-200 p-4">
        <p className="text-sm text-amber-800 font-medium">Admin settings are not editable in the demo version.</p>
        <p className="text-xs text-amber-700 mt-1">Full configuration will be available in the production release.</p>
      </div>
